export default class ScnLoad extends Phaser.Scene {
    ...
    preload(){
        ...
        this.load.image("sprLcarsPipLong32", "sprites/lcarsPipLong32.png");
        this.load.image("sprLcarsPipLong48", "sprites/lcarsPipLong48.png");
        this.load.image("sprLcarsPipLong64", "sprites/lcarsPipLong64.png");
        ...
        this.load.image("sprWhiteSimpleHeading02", "sprites/whiteSimpleHeading02.png");
        ...
        this.load.image("sprSymbolTarget", "sprites/symbolTarget.png");
        this.load.image("sprSymbolWaypoint", "sprites/symbolWaypoint.png");
        ...
        this.load.image("sprChefOBran00", "sprites/characters/chefOBran00.png");

        this.load.image("sprParticleLong00", "sprites/particleLong01.png");
        ...
        this.load.json("bajaDerrek00", "jsons/bajaDerrek00.json");
        this.load.json("bajaChefOBran00", "jsons/bajaChefOBran00.json");
